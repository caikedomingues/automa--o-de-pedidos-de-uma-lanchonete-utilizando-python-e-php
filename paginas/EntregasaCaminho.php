                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            <div class="p-3 bg-white border rounded">
                                ...
                                <?php
                                    # Ira nos dar acesso a sessão criada pelo usuário
                                    # através dos valores definidos na superglobal 
                                    # $_SESSION
                                    session_start();

                                    # Ira importar para o arquivo as classes que iremos
                                    # utilizar no sistema.
                                    require_once '../classes/BancoDeDados.php';
                                    require_once '../classes/Pedidos.php';

                                    # Instância da classe banco que ira conter a conexão com o
                                    # banco de dados.
                                    ...
                                    # Ira criar a classe pedidos que receberá em seu construtor
                                    # a conexão com o banco de dados.
                                    $pedidos = new Pedidos($conexao);
                                    
                                    # Ira chamar o método que consulta as entregas que estão sendo realizadas 
                                    $pedidos->TodasEntregasNaoRealizadas();
                                ?>
